...
jpeg(paste0(Sys.getenv("AA_DATA_DIR"), 
            "/public/exploration/eth/spi/SPI-3 for JAS 2021.jpg"), width = 1100, height = 600)
...
jpeg(paste0(Sys.getenv("AA_DATA_DIR"), 
            "/public/exploration/eth/spi/SPI-3 for JAS 2021 for (Agro)Pastoral Zones.jpg"), 
...
jpeg(paste0(Sys.getenv("AA_DATA_DIR"), 
            "/public/exploration/eth/spi/SPI-3 for MAM 2022.jpg"), 
     width = 1100, height = 600)
...
ethSF5 <- ethSF3 %>%
    mutate(spi = ifelse(pastoral_lz, spi, NA))
jpeg(paste0(Sys.getenv("AA_DATA_DIR"), 
            "/public/exploration/eth/spi/SPI-3 for MAM 2022 for (Agro)Pastoral Zones.jpg"), 
     width = 1100, height = 600)
